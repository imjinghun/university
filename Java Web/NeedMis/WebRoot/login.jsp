<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    <head>
       ...
       <script>
            ...
            var randcode=document.getElementById("randcode").value.trim();
          
            if(username == "")
            {
           	 	layer.tips('用户名不能为空', '#username',{tips: [2, '#1874CD'],time:1200});
           	 	document.getElementById("username").focus();
           	 	return false;
            }
             if(password == "")
            {
           	 	layer.tips('密码不能为空', '#password',{tips: [2, '#1874CD'],time:1200});
           	 	document.getElementById("password").focus();
           	 	return false;
            }
            
           // var verifyCode = new GVerify("v_container");
          //  var res = verifyCode.validate(document.getElementById("randcode").value);
            if(randcode == "")
            {
           	 	layer.tips('验证码不能为空', '#randcode',{tips: [2, '#1874CD'],time:1200});
           	 	document.getElementById("randcode").focus();
           	 	return false;
            }
            if(randcode.length!=4)
            {
           	 	layer.tips('验证码不正确', '#randcode',{tips: [2, '#1874CD'],time:1200});
           	 	document.getElementById("randcode").focus();
           	 	return false;
            }
           /*  if(!res){
				//alert("验证码错误");
				layer.tips('验证码输入有误', '#randcode',{tips: [2, '#1874CD'],time:1200});
           	 	document.getElementById("randcode").focus();
           	 	return false;
			} */
              return true;
    ...
    <body onLoad="inputfocus()">
		...
		<form name="form1" action="user_login" method="post" onsubmit="return check()">
                    ...
                    <table width="100%" height="116" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" align="left" valign="bottom">
                                <!-- 用户名 -->
                                <input type="text" name="username" id="username" value="${user.username}"  class="STYLE1" maxlength="20" STYLE="width: 180px; height: 17px; border: #336699 1px solid" tabindex="1" />
                            </td>
                        </tr>
                        <tr>
                            <td height="32" colspan="2" align="left" valign="bottom">
                                <!-- 密码 -->
                                <input type="password" name="password" id="password" value="${user.password}"  class="STYLE1" maxlength="20" STYLE="width: 180px; height: 17px; border: #336699 1px solid" tabindex="1"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%" height="29" align="left" valign="bottom">
                                <!-- 验证码 -->
                                <input type="text" name="randcode" id="randcode" class="STYLE1" maxlength="4" STYLE="width: 100px; height: 17px; border: #336699 1px solid" tabindex="1" />
                            </td>
                        ...
                        <tr>
                            ...
                            <span style="color:red;"><s:property value="errors.user[0]"/></span>
                            </td>
                        </tr>
                    </table>
                </td>
