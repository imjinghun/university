...
<body>
	...
	%>
         ...
         <form id="form1" name="form1" method="post" action="need_save" onsubmit="return check()">
            <table frame="border" rules="all" >
                <tr>
                    <td scope="row" width="12%"><font color="red">*</font>机构全称</td>
                    <td width="28%">
                    	<input type="text" name="organname" value="${user1.organname}" class="input1" maxlength="100" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="contactaddr" id="contactaddr" value="${user1.contactaddr}" class="input1" maxlength="100" />
                    </td>
                    <td colspan="3" align="left">
                ...
                <tr>
                    <td scope="row">网&nbsp;址</td>
                    <td>
                        <input type="text" name="unitweb" id="unitweb" value="${user1.unitweb}" class="input1" maxlength="255" />
                    </td>
                    <td colspan="2"><font color="red" >*</font>电子信箱</td>
                    <td>
                        <input type="text" name="email" id="email" value="${user1.email}" class="input1" maxlength="50" onblur="emailcheck()"/>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="legalperson" id="legalperson" value="${user1.legalperson}" class="input1" maxlength="20" />
                    </td>
                    <td colspan="2" width="8%">邮政编码</td>
                    <td >
                        <input type="text" name="postcode" id="postcode" value="${user1.postcode}" class="input1" maxlength="6" onblur="ybcheck()"/>
                    </td>
                    <td colspan="2" align="left">
                ...
                <tr>
                    ...
                    <td >
                        <input type="text" name="contacts" id="contacts" value="${user1.contacts}" class="input1"  maxlength="20" />
                    </td>
                    <td colspan="2">固定电话</td>	
                    <td >
                        <input type="text" name="tel" id="tel" value="${user1.tel}" class="input1" maxlength="12" onblur="ghcheck()"/>
                    </td>
                   <td colspan="2" align="left"> 
                ...
                <tr>
                    ...
                    <td >
                        <input type="text" name="phone" id="phone" value="${user1.phone}" class="input1" maxlength="11" onblur="sjcheck()"/>
                    </td>
                    <td colspan="2">传真</td>
                    <td >
                        <input type="text" name="fax" id="fax" value="${user1.fax}" class="input1" maxlength="12" />
                    </td>
                    <td colspan="3" align="left">
                ...
                <tr>
                 <td scope="row">
                    ...
                    <td colspan="6" align="left">
                    	...
                    	<textarea name="organInfo" id="organInfo" cols="45" rows="5" class="textarea1" maxlength="500"></textarea>
                    </td>
                </tr>
                <tr>
                    <td scope="row"><font color="red">*</font>技术需求名称</td>
                    <td>
                        <input type="text" name="needname" id="needname" class="input1" maxlength="100" style="height:100%;"/>
                    </td>
                    <td colspan="2"><font color="red">*</font>需求时限</td>
                    <td  align="left">
                        <input type="text" name="needsyear" style="width:80px;height:100%" maxlength="4" onblur="xqsx()"/> 年至
                        <input type="text" name="needeyear" style="width:80px;height:100%" maxlength="4" onblur="xqsx2()"/> 年
                    </td>
                    <td colspan="2" align="left">
                ...
                <tr>
                    ...
                    <td height="63" colspan="6" align="left">
                        ...
                        <textarea name="needoverview1" id="needoverview1" cols="45" rows="5" class="textarea1" maxlength="500"></textarea>
                        <p class="tip1">2、技术关键（所需的关键技术、主要指标，限500字以内）</p>
                        <textarea name="needoverview2" id="needoverview2" cols="45" rows="5" class="textarea1" maxlength="500"></textarea>
                        <p class="tip1">3、预期目标（技术创新性、经济社会效益，限500字以内）</p>
                        <textarea name="needoverview3" id="needoverview3" cols="45" rows="5" class="textarea1" maxlength="500"></textarea>
                    </td>
                ...
                <tr>
                    <td>
                        ...
                        <input type="hidden" name="needkey" id="needkey"/>
                    </td>
                    <td colspan="6" align="left">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="totalmoney" id="totalmoney" class="input1" onblur="zjzecheck()" />
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="6" align="left">
                        <input type="text" name="coopunit" id="coopunit" class="input1" style="height:28px;" maxlength="100" />
                    </td>
                </tr>
                <tr>
